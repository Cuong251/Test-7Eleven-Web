...
3. **Truy cập các dịch vụ:**
   ...
   * **PostgreSQL Database Port:** `5433` (được map từ cổng `5432` của container database ra máy local)
...
2. Đảm bảo PostgreSQL chạy ở cổng `5433` (hoặc cổng mặc định `5432` của bạn).
...
| **Port** | `5433` (hoặc `5432` tùy cấu hình) | `5432` (nội bộ container) / `5433` (cổng được map ra ngoài máy) |
| **Database Name** | `seven_eleven_db` | `seven_eleven_db` |
| **Username** | `postgres` | `postgres` |
| **Password** | `1234` (hoặc mật khẩu của bạn) | `1234` |
| **Connection URL** | `jdbc:postgresql://localhost:5433/seven_eleven_db` | `jdbc:postgresql://db:5432/seven_eleven_db` |
